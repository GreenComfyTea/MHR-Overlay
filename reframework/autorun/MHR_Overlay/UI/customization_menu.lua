...
function customization_menu.draw_small_monster_UI()
	...
	if imgui.tree_node(language.current_language.customization_menu.small_monster_UI) then
		...
		if imgui.tree_node(language.current_language.customization_menu.ailments) then
			...
			if imgui.tree_node(language.current_language.customization_menu.settings) then
				changed, cached_config.ailments.settings.hide_ailments_with_zero_buildup =
					imgui.checkbox(language.current_language.customization_menu.hide_ailments_with_zero_buildup,
						cached_config.ailments.settings.hide_ailments_with_zero_buildup);
				config_changed = config_changed or changed;
				changed, cached_config.ailments.settings.hide_inactive_ailments_with_no_buildup_support = imgui.checkbox(
				...
				config_changed = config_changed or changed;
				changed, cached_config.ailments.settings.hide_all_inactive_ailments =
					imgui.checkbox(language.current_language.customization_menu.hide_all_inactive_ailments,
						cached_config.ailments.settings.hide_all_inactive_ailments);
				config_changed = config_changed or changed;
				changed, cached_config.ailments.settings.hide_all_active_ailments =
					imgui.checkbox(language.current_language.customization_menu.hide_all_active_ailments,
						cached_config.ailments.settings.hide_all_active_ailments);
				config_changed = config_changed or changed;
				changed, cached_config.ailments.settings.hide_disabled_ailments =
					imgui.checkbox(language.current_language.customization_menu.hide_disabled_ailments,
						cached_config.ailments.settings.hide_disabled_ailments);
				config_changed = config_changed or changed;
				changed, cached_config.ailments.settings.time_limit = imgui.drag_float(
					language.current_language.customization_menu.time_limit, cached_config.ailments.settings.time_limit, 0.1, 0, 99999,
					"%.1f");
				config_changed = config_changed or changed;
				imgui.tree_pop();
			end
			if imgui.tree_node(language.current_language.customization_menu.sorting) then
				changed, index = imgui.combo(language.current_language.customization_menu.type, table_helpers.find_index(
					customization_menu.ailments_sorting_types, cached_config.ailments.sorting.type),
					customization_menu.displayed_ailments_sorting_types);
				config_changed = config_changed or changed;
				if changed then
					cached_config.ailments.sorting.type = customization_menu.ailments_sorting_types[index];
				end
				changed, cached_config.ailments.sorting.reversed_order = imgui.checkbox(
					language.current_language.customization_menu.reversed_order, cached_config.ailments.sorting.reversed_order);
				config_changed = config_changed or changed;
				imgui.tree_pop();
			end
			if imgui.tree_node(language.current_language.customization_menu.filter) then
				...
				config_changed = config_changed or changed;
				changed, cached_config.ailments.filter.thunderblight = imgui.checkbox(
					language.current_language.ailments.thunderblight, cached_config.ailments.filter.thunderblight);
				config_changed = config_changed or changed;
				...
				config_changed = config_changed or changed;
				changed, cached_config.ailments.filter.fall_otomo_trap = imgui.checkbox(
					language.current_language.ailments.fall_otomo_trap, cached_config.ailments.filter.fall_otomo_trap);
				config_changed = config_changed or changed;
				changed, cached_config.ailments.filter.shock_otomo_trap = imgui.checkbox(
					language.current_language.ailments.shock_otomo_trap, cached_config.ailments.filter.shock_otomo_trap);
				config_changed = config_changed or changed;
				imgui.tree_pop();
			end
			if imgui.tree_node(language.current_language.customization_menu.ailment_name_label) then
				changed, cached_config.ailments.ailment_name_label.visibility =
					imgui.checkbox(language.current_language.customization_menu.visible,
						cached_config.ailments.ailment_name_label.visibility);
				config_changed = config_changed or changed;
				if imgui.tree_node(language.current_language.customization_menu.include) then
					changed, cached_config.ailments.ailment_name_label.include.ailment_name =
						imgui.checkbox(language.current_language.customization_menu.ailment_name,
							cached_config.ailments.ailment_name_label.include.ailment_name);
					config_changed = config_changed or changed;
					changed, cached_config.ailments.ailment_name_label.include.activation_count = imgui.checkbox(
						language.current_language.customization_menu.activation_count,
						cached_config.ailments.ailment_name_label.include.activation_count);
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
				if imgui.tree_node(language.current_language.customization_menu.offset) then
					changed, cached_config.ailments.ailment_name_label.offset.x =
						imgui.drag_float(language.current_language.customization_menu.x,
							cached_config.ailments.ailment_name_label.offset.x, 0.1, -screen.width, screen.width, "%.1f");
					config_changed = config_changed or changed;
					changed, cached_config.ailments.ailment_name_label.offset.y =
						imgui.drag_float(language.current_language.customization_menu.y,
							cached_config.ailments.ailment_name_label.offset.y, 0.1, -screen.height, screen.height, "%.1f");
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
				if imgui.tree_node(language.current_language.customization_menu.color) then
					changed, cached_config.ailments.ailment_name_label.color =
						imgui.color_picker_argb("", cached_config.ailments.ailment_name_label.color, customization_menu.color_picker_flags);
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
				if imgui.tree_node(language.current_language.customization_menu.shadow) then
					changed, cached_config.ailments.ailment_name_label.shadow.visibility =
						imgui.checkbox(language.current_language.customization_menu.visible,
							cached_config.ailments.ailment_name_label.shadow.visibility);
					config_changed = config_changed or changed;
					if imgui.tree_node(language.current_language.customization_menu.offset) then
						changed, cached_config.ailments.ailment_name_label.shadow.offset.x =
							imgui.drag_float(language.current_language.customization_menu.x,
								cached_config.ailments.ailment_name_label.shadow.offset.x, 0.1, -screen.width, screen.width, "%.1f");
						config_changed = config_changed or changed;
						changed, cached_config.ailments.ailment_name_label.shadow.offset.y =
							imgui.drag_float(language.current_language.customization_menu.y,
								cached_config.ailments.ailment_name_label.shadow.offset.y, 0.1, -screen.height, screen.height, "%.1f");
						config_changed = config_changed or changed;
						imgui.tree_pop();
					end
					if imgui.tree_node(language.current_language.customization_menu.color) then
		...
		if imgui.tree_node(language.current_language.customization_menu.ailment_buildups) then
			changed, cached_config.ailment_buildups.visibility = imgui.checkbox(
				language.current_language.customization_menu.visible, cached_config.ailment_buildups.visibility);
			config_changed = config_changed or changed;
			if imgui.tree_node(language.current_language.customization_menu.offset) then
			...
			if imgui.tree_node(language.current_language.customization_menu.player_spacing) then
				changed, cached_config.ailment_buildups.player_spacing.x =
					imgui.drag_float(language.current_language.customization_menu.x, cached_config.ailment_buildups.player_spacing.x,
						0.1, -screen.width, screen.width, "%.1f");
				config_changed = config_changed or changed;
				changed, cached_config.ailment_buildups.player_spacing.y =
					imgui.drag_float(language.current_language.customization_menu.y, cached_config.ailment_buildups.player_spacing.y,
						0.1, -screen.height, screen.height, "%.1f");
				config_changed = config_changed or changed;
				imgui.tree_pop();
			end
			if imgui.tree_node(language.current_language.customization_menu.ailment_spacing) then
				changed, cached_config.ailment_buildups.ailment_spacing.x =
					imgui.drag_float(language.current_language.customization_menu.x, cached_config.ailment_buildups.ailment_spacing.x,
						0.1, -screen.width, screen.width, "%.1f");
				config_changed = config_changed or changed;
				changed, cached_config.ailment_buildups.ailment_spacing.y =
					imgui.drag_float(language.current_language.customization_menu.y, cached_config.ailment_buildups.ailment_spacing.y,
						0.1, -screen.height, screen.height, "%.1f");
				config_changed = config_changed or changed;
				imgui.tree_pop();
			end
			if imgui.tree_node(language.current_language.customization_menu.settings) then
				...
				if changed then
					cached_config.ailment_buildups.settings.buildup_bar_relative_to =
						customization_menu.displayed_buildup_bar_relative_types[index];
				end
				changed, cached_config.ailment_buildups.settings.time_limit =
					imgui.drag_float(language.current_language.customization_menu.time_limit,
						cached_config.ailment_buildups.settings.time_limit, 0.1, 0, 99999, "%.1f");
				config_changed = config_changed or changed;
				imgui.tree_pop();
			end
			if imgui.tree_node(language.current_language.customization_menu.filter) then
			...
			if imgui.tree_node(language.current_language.customization_menu.sorting) then
				changed, index = imgui.combo(language.current_language.customization_menu.type, table_helpers.find_index(
					customization_menu.ailment_buildups_sorting_types, cached_config.ailment_buildups.sorting.type),
					customization_menu.displayed_ailment_buildups_sorting_types);
				config_changed = config_changed or changed;
				if changed then
					cached_config.ailment_buildups.sorting.type = customization_menu.ailment_buildups_sorting_types[index];
				end
				changed, cached_config.ailment_buildups.sorting.reversed_order =
					imgui.checkbox(language.current_language.customization_menu.reversed_order,
						cached_config.ailment_buildups.sorting.reversed_order);
				config_changed = config_changed or changed;
				imgui.tree_pop();
			end
			if imgui.tree_node(language.current_language.customization_menu.ailment_name_label) then
				changed, cached_config.ailment_buildups.ailment_name_label.visibility =
					imgui.checkbox(language.current_language.customization_menu.visible,
						cached_config.ailment_buildups.ailment_name_label.visibility);
				config_changed = config_changed or changed;
				if imgui.tree_node(language.current_language.customization_menu.include) then
					changed, cached_config.ailment_buildups.ailment_name_label.include.ailment_name = imgui.checkbox(
						language.current_language.customization_menu.ailment_name,
						cached_config.ailment_buildups.ailment_name_label.include.ailment_name);
					config_changed = config_changed or changed;
					changed, cached_config.ailment_buildups.ailment_name_label.include.activation_count = imgui.checkbox(
						language.current_language.customization_menu.activation_count,
						cached_config.ailment_buildups.ailment_name_label.include.activation_count);
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
				if imgui.tree_node(language.current_language.customization_menu.offset) then
					changed, cached_config.ailment_buildups.ailment_name_label.offset.x =
						imgui.drag_float(language.current_language.customization_menu.x,
							cached_config.ailment_buildups.ailment_name_label.offset.x, 0.1, -screen.width, screen.width, "%.1f");
					config_changed = config_changed or changed;
					changed, cached_config.ailment_buildups.ailment_name_label.offset.y =
						imgui.drag_float(language.current_language.customization_menu.y,
							cached_config.ailment_buildups.ailment_name_label.offset.y, 0.1, -screen.height, screen.height, "%.1f");
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
				if imgui.tree_node(language.current_language.customization_menu.color) then
				...
				if imgui.tree_node(language.current_language.customization_menu.shadow) then
					changed, cached_config.ailment_buildups.ailment_name_label.shadow.visibility = imgui.checkbox(
						language.current_language.customization_menu.visible,
						cached_config.ailment_buildups.ailment_name_label.shadow.visibility);
					config_changed = config_changed or changed;
					if imgui.tree_node(language.current_language.customization_menu.offset) then
						changed, cached_config.ailment_buildups.ailment_name_label.shadow.offset.x = imgui.drag_float(
							language.current_language.customization_menu.x,
							cached_config.ailment_buildups.ailment_name_label.shadow.offset.x, 0.1, -screen.width, screen.width, "%.1f");
						config_changed = config_changed or changed;
						changed, cached_config.ailment_buildups.ailment_name_label.shadow.offset.y = imgui.drag_float(
							language.current_language.customization_menu.y,
							cached_config.ailment_buildups.ailment_name_label.shadow.offset.y, 0.1, -screen.height, screen.height, "%.1f");
						config_changed = config_changed or changed;
						imgui.tree_pop();
					end
					if imgui.tree_node(language.current_language.customization_menu.color) then
...
function customization_menu.draw_large_monster_dynamic_UI()
	...
	if imgui.tree_node(language.current_language.customization_menu.dynamically_positioned) then
		...
		if imgui.tree_node(language.current_language.customization_menu.settings) then
			...
			config_changed = config_changed or changed;
			changed, cached_config.settings.render_highlighted_monster =
				imgui.checkbox(language.current_language.customization_menu.render_highlighted_monster,
					cached_config.settings.render_highlighted_monster);
			config_changed = config_changed or changed;
			changed, cached_config.settings.render_not_highlighted_monsters =
				imgui.checkbox(language.current_language.customization_menu.render_not_highlighted_monsters,
					cached_config.settings.render_not_highlighted_monsters);
			config_changed = config_changed or changed;
		...
		if imgui.tree_node(language.current_language.customization_menu.monster_name_label) then
			...
			config_changed = config_changed or changed;
			if imgui.tree_node(language.current_language.customization_menu.include) then
				changed, cached_config.monster_name_label.include.monster_name =
					imgui.checkbox(language.current_language.customization_menu.monster_name,
						cached_config.monster_name_label.include.monster_name);
				config_changed = config_changed or changed;
				changed, cached_config.monster_name_label.include.monster_id =
					imgui.checkbox(language.current_language.customization_menu.monster_id,
						cached_config.monster_name_label.include.monster_id);
				config_changed = config_changed or changed;
				changed, cached_config.monster_name_label.include.crown =
					imgui.checkbox(language.current_language.customization_menu.crown, cached_config.monster_name_label.include.crown);
				config_changed = config_changed or changed;
				...
				config_changed = config_changed or changed;
				changed, cached_config.monster_name_label.include.scrown_thresholds =
					imgui.checkbox(language.current_language.customization_menu.crown_thresholds,
						cached_config.monster_name_label.include.scrown_thresholds);
				config_changed = config_changed or changed;
				imgui.tree_pop();
			end
			if imgui.tree_node(language.current_language.customization_menu.offset) then
				changed, cached_config.monster_name_label.offset.x = imgui.drag_float(
					language.current_language.customization_menu.x, cached_config.monster_name_label.offset.x, 0.1, -screen.width,
					screen.width, "%.1f");
				config_changed = config_changed or changed;
				changed, cached_config.monster_name_label.offset.y = imgui.drag_float(
					language.current_language.customization_menu.y, cached_config.monster_name_label.offset.y, 0.1, -screen.height,
					screen.height, "%.1f");
				config_changed = config_changed or changed;
				imgui.tree_pop();
			end
			...
			if imgui.tree_node(language.current_language.customization_menu.shadow) then
				changed, cached_config.monster_name_label.shadow.visibility =
					imgui.checkbox(language.current_language.customization_menu.visible,
						cached_config.monster_name_label.shadow.visibility);
				config_changed = config_changed or changed;
				if imgui.tree_node(language.current_language.customization_menu.offset) then
					changed, cached_config.monster_name_label.shadow.offset.x =
						imgui.drag_float(language.current_language.customization_menu.x, cached_config.monster_name_label.shadow.offset.x,
							0.1, -screen.width, screen.width, "%.1f");
					config_changed = config_changed or changed;
					changed, cached_config.monster_name_label.shadow.offset.y =
						imgui.drag_float(language.current_language.customization_menu.y, cached_config.monster_name_label.shadow.offset.y,
							0.1, -screen.height, screen.height, "%.1f");
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
		...
		if imgui.tree_node(language.current_language.customization_menu.body_parts) then
			...
			if imgui.tree_node(language.current_language.customization_menu.settings) then
				changed, cached_config.body_parts.settings.hide_undamaged_parts =
					imgui.checkbox(language.current_language.customization_menu.hide_undamaged_parts,
						cached_config.body_parts.settings.hide_undamaged_parts);
				config_changed = config_changed or changed;
				changed, cached_config.body_parts.settings.time_limit = imgui.drag_float(language.current_language
					                                                                         .customization_menu.time_limit,
					cached_config.body_parts.settings.time_limit, 0.1, 0, 99999, "%.1f");
				config_changed = config_changed or changed;
				imgui.tree_pop();
			end
			if imgui.tree_node(language.current_language.customization_menu.sorting) then
				changed, index = imgui.combo(language.current_language.customization_menu.type, table_helpers.find_index(
					customization_menu.large_monster_UI_parts_sorting_types, cached_config.body_parts.sorting.type),
					customization_menu.displayed_monster_UI_parts_sorting_types);
				config_changed = config_changed or changed;
				if changed then
					cached_config.body_parts.sorting.type = customization_menu.large_monster_UI_parts_sorting_types[index];
				end
				changed, cached_config.body_parts.sorting.reversed_order =
					imgui.checkbox(language.current_language.customization_menu.reversed_order,
						cached_config.body_parts.sorting.reversed_order);
				config_changed = config_changed or changed;
				imgui.tree_pop();
			end
			if imgui.tree_node(language.current_language.customization_menu.filter) then
				changed, cached_config.body_parts.filter.health_break_severe =
					imgui.checkbox(language.current_language.customization_menu.health_break_severe_filter,
						cached_config.body_parts.filter.health_break_severe);
				config_changed = config_changed or changed;
				changed, cached_config.body_parts.filter.health_break = imgui.checkbox(
					language.current_language.customization_menu.health_break_filter, cached_config.body_parts.filter.health_break);
				config_changed = config_changed or changed;
				changed, cached_config.body_parts.filter.health_severe = imgui.checkbox(
					language.current_language.customization_menu.health_severe_filter, cached_config.body_parts.filter.health_severe);
				config_changed = config_changed or changed;
				changed, cached_config.body_parts.filter.health = imgui.checkbox(
					language.current_language.customization_menu.health_filter, cached_config.body_parts.filter.health);
				config_changed = config_changed or changed;
				changed, cached_config.body_parts.filter.break_severe = imgui.checkbox(
					language.current_language.customization_menu.break_severe_filter, cached_config.body_parts.filter.break_severe);
				config_changed = config_changed or changed;
				changed, cached_config.body_parts.filter.break_ = imgui.checkbox(
					language.current_language.customization_menu.break_filter, cached_config.body_parts.filter.break_);
				config_changed = config_changed or changed;
				changed, cached_config.body_parts.filter.severe = imgui.checkbox(
					language.current_language.customization_menu.severe_filter, cached_config.body_parts.filter.severe);
				config_changed = config_changed or changed;
				imgui.tree_pop();
			end
			if imgui.tree_node(language.current_language.customization_menu.part_name_label) then
				changed, cached_config.body_parts.part_name_label.visibility =
					imgui.checkbox(language.current_language.customization_menu.visible,
						cached_config.body_parts.part_name_label.visibility);
				config_changed = config_changed or changed;
				if imgui.tree_node(language.current_language.customization_menu.include) then
					changed, cached_config.body_parts.part_name_label.include.part_name =
						imgui.checkbox(language.current_language.customization_menu.part_name,
							cached_config.body_parts.part_name_label.include.part_name);
					config_changed = config_changed or changed;
					changed, cached_config.body_parts.part_name_label.include.flinch_count =
						imgui.checkbox(language.current_language.customization_menu.flinch_count,
							cached_config.body_parts.part_name_label.include.flinch_count);
					config_changed = config_changed or changed;
					changed, cached_config.body_parts.part_name_label.include.break_count =
						imgui.checkbox(language.current_language.customization_menu.break_count,
							cached_config.body_parts.part_name_label.include.break_count);
					config_changed = config_changed or changed;
					changed, cached_config.body_parts.part_name_label.include.break_max_count = imgui.checkbox(
						language.current_language.customization_menu.break_max_count,
						cached_config.body_parts.part_name_label.include.break_max_count);
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
				if imgui.tree_node(language.current_language.customization_menu.offset) then
					changed, cached_config.body_parts.part_name_label.offset.x =
						imgui.drag_float(language.current_language.customization_menu.x,
							cached_config.body_parts.part_name_label.offset.x, 0.1, -screen.width, screen.width, "%.1f");
					config_changed = config_changed or changed;
					changed, cached_config.body_parts.part_name_label.offset.y =
						imgui.drag_float(language.current_language.customization_menu.y,
							cached_config.body_parts.part_name_label.offset.y, 0.1, -screen.height, screen.height, "%.1f");
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
				if imgui.tree_node(language.current_language.customization_menu.color) then
					changed, cached_config.body_parts.part_name_label.color =
						imgui.color_picker_argb("", cached_config.body_parts.part_name_label.color, customization_menu.color_picker_flags);
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
				if imgui.tree_node(language.current_language.customization_menu.shadow) then
					changed, cached_config.body_parts.part_name_label.shadow.visibility =
						imgui.checkbox(language.current_language.customization_menu.visible,
							cached_config.body_parts.part_name_label.shadow.visibility);
					config_changed = config_changed or changed;
					if imgui.tree_node(language.current_language.customization_menu.offset) then
						changed, cached_config.body_parts.part_name_label.shadow.offset.x =
							imgui.drag_float(language.current_language.customization_menu.x,
								cached_config.body_parts.part_name_label.shadow.offset.x, 0.1, -screen.width, screen.width, "%.1f");
						config_changed = config_changed or changed;
						changed, cached_config.body_parts.part_name_label.shadow.offset.y =
							imgui.drag_float(language.current_language.customization_menu.y,
								cached_config.body_parts.part_name_label.shadow.offset.y, 0.1, -screen.height, screen.height, "%.1f");
						config_changed = config_changed or changed;
						imgui.tree_pop();
					end
					if imgui.tree_node(language.current_language.customization_menu.color) then
			...
			if imgui.tree_node(language.current_language.customization_menu.part_health) then
				changed, cached_config.body_parts.part_health.visibility =
					imgui.checkbox(language.current_language.customization_menu.visible,
						cached_config.body_parts.part_health.visibility);
				config_changed = config_changed or changed;
				if imgui.tree_node(language.current_language.customization_menu.offset) then
					changed, cached_config.body_parts.part_health.offset.x =
						imgui.drag_float(language.current_language.customization_menu.x, cached_config.body_parts.part_health.offset.x,
							0.1, -screen.width, screen.width, "%.1f");
					config_changed = config_changed or changed;
					changed, cached_config.body_parts.part_health.offset.y =
						imgui.drag_float(language.current_language.customization_menu.y, cached_config.body_parts.part_health.offset.y,
							0.1, -screen.height, screen.height, "%.1f");
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
			...
			if imgui.tree_node(language.current_language.customization_menu.break_health) then
				changed, cached_config.body_parts.part_break.visibility =
					imgui.checkbox(language.current_language.customization_menu.visible, cached_config.body_parts.part_break.visibility);
				config_changed = config_changed or changed;
				if imgui.tree_node(language.current_language.customization_menu.offset) then
					changed, cached_config.body_parts.part_break.offset.x =
						imgui.drag_float(language.current_language.customization_menu.x, cached_config.body_parts.part_break.offset.x,
							0.1, -screen.width, screen.width, "%.1f");
					config_changed = config_changed or changed;
					changed, cached_config.body_parts.part_break.offset.y =
						imgui.drag_float(language.current_language.customization_menu.y, cached_config.body_parts.part_break.offset.y,
							0.1, -screen.height, screen.height, "%.1f");
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
			...
			if imgui.tree_node(language.current_language.customization_menu.loss_health) then
				changed, cached_config.body_parts.part_loss.visibility = imgui.checkbox(
					language.current_language.customization_menu.visible, cached_config.body_parts.part_loss.visibility);
				config_changed = config_changed or changed;
				if imgui.tree_node(language.current_language.customization_menu.offset) then
					changed, cached_config.body_parts.part_loss.offset.x = imgui.drag_float(language.current_language
						                                                                        .customization_menu.x,
						cached_config.body_parts.part_loss.offset.x, 0.1, -screen.width, screen.width, "%.1f");
					config_changed = config_changed or changed;
					changed, cached_config.body_parts.part_loss.offset.y = imgui.drag_float(language.current_language
						                                                                        .customization_menu.y,
						cached_config.body_parts.part_loss.offset.y, 0.1, -screen.height, screen.height, "%.1f");
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
				changed = label_customization.draw(language.current_language.customization_menu.text_label,
			...
			if imgui.tree_node(language.current_language.customization_menu.settings) then
				...
				changed, cached_config.ailments.settings.hide_disabled_ailments =
					imgui.checkbox(language.current_language.customization_menu.hide_disabled_ailments,
						cached_config.ailments.settings.hide_disabled_ailments);
				config_changed = config_changed or changed;
				changed, cached_config.ailments.settings.offset_is_relative_to_parts =
					imgui.checkbox(language.current_language.customization_menu.offset_is_relative_to_parts,
						cached_config.ailments.settings.offset_is_relative_to_parts);
				config_changed = config_changed or changed;
				changed, cached_config.ailments.settings.time_limit = imgui.drag_float(
					language.current_language.customization_menu.time_limit, cached_config.ailments.settings.time_limit, 0.1, 0, 99999,
					"%.1f");
...
function customization_menu.draw_large_monster_static_UI()
	...
	if imgui.tree_node(language.current_language.customization_menu.statically_positioned) then
		...
		if imgui.tree_node(language.current_language.customization_menu.settings) then
			...
			if changed then
				cached_config.settings.highlighted_monster_location =
					customization_menu.damage_meter_UI_my_damage_bar_location_types[index];
			end
			changed, index = imgui.combo(language.current_language.customization_menu.orientation, table_helpers.find_index(
				customization_menu.orientation_types, cached_config.settings.orientation),
				customization_menu.displayed_orientation_types);
			config_changed = config_changed or changed;
			if changed then
				cached_config.settings.orientation = customization_menu.orientation_types[index];
		...
		if imgui.tree_node(language.current_language.customization_menu.position) then
			...
			config_changed = config_changed or changed;
			changed, index = imgui.combo(language.current_language.customization_menu.anchor, table_helpers.find_index(
				customization_menu.anchor_types, cached_config.position.anchor), customization_menu.displayed_anchor_types);
			config_changed = config_changed or changed;
			if changed then
		...
		if imgui.tree_node(language.current_language.customization_menu.sorting) then
			changed, index = imgui.combo(language.current_language.customization_menu.type, table_helpers.find_index(
				customization_menu.monster_UI_sorting_types, cached_config.sorting.type),
				customization_menu.displayed_monster_UI_sorting_types);
			config_changed = config_changed or changed;
			if changed then
...
function customization_menu.draw_time_UI()
	...
	if imgui.tree_node(language.current_language.customization_menu.time_UI) then
		...
		if imgui.tree_node(language.current_language.customization_menu.position) then
			...
			config_changed = config_changed or changed;
			changed, index = imgui.combo(language.current_language.customization_menu.anchor, table_helpers.find_index(
				customization_menu.anchor_types, cached_config.position.anchor),
...
function customization_menu.draw_damage_meter_UI()
	...
	if imgui.tree_node(language.current_language.customization_menu.damage_meter_UI) then
		...
		if imgui.tree_node(language.current_language.customization_menu.settings) then
			...
			config_changed = config_changed or changed;
			changed, cached_config.settings.hide_module_if_total_damage_is_zero =
				imgui.checkbox(language.current_language.customization_menu.hide_module_if_total_damage_is_zero,
					cached_config.settings.hide_module_if_total_damage_is_zero);
			config_changed = config_changed or changed;
			changed, cached_config.settings.hide_player_if_player_damage_is_zero =
			...
			config_changed = config_changed or changed;
			changed, cached_config.settings.hide_total_if_total_damage_is_zero =
				imgui.checkbox(language.current_language.customization_menu.hide_total_if_total_damage_is_zero,
					cached_config.settings.hide_total_if_total_damage_is_zero);
			config_changed = config_changed or changed;
			changed, cached_config.settings.total_damage_offset_is_relative =
				imgui.checkbox(language.current_language.customization_menu.total_damage_offset_is_relative,
					cached_config.settings.total_damage_offset_is_relative);
			config_changed = config_changed or changed;
			changed, cached_config.settings.freeze_dps_on_quest_clear =
				imgui.checkbox(language.current_language.customization_menu.freeze_dps_on_quest_clear,
					cached_config.settings.freeze_dps_on_quest_clear);
			config_changed = config_changed or changed;
			changed, index = imgui.combo(language.current_language.customization_menu.orientation, table_helpers.find_index(
				customization_menu.orientation_types, cached_config.settings.orientation),
				customization_menu.displayed_orientation_types);
			...
			changed, index = imgui.combo(language.current_language.customization_menu.dps_mode, table_helpers.find_index(
				customization_menu.damage_meter_UI_dps_modes, cached_config.settings.dps_mode),
				customization_menu.displayed_damage_meter_UI_dps_modes);
			config_changed = config_changed or changed;
			if changed then
				cached_config.settings.dps_mode = customization_menu.damage_meter_UI_dps_modes[index];
			end
			changed, cached_config.settings.player_name_size_limit = imgui.drag_float(language.current_language
				                                                                          .customization_menu.player_name_size_limit,
				cached_config.settings.player_name_size_limit, 0.1, 0, screen.width, "%.1f");
			config_changed = config_changed or changed;
			imgui.tree_pop();
		end
		if imgui.tree_node(language.current_language.customization_menu.tracked_monster_types) then
			...
			changed, cached_config.tracked_monster_types.small_monsters =
				imgui.checkbox(language.current_language.customization_menu.small_monsters,
					cached_config.tracked_monster_types.small_monsters);
			config_changed = config_changed or changed;
			tracked_monster_types_changed = tracked_monster_types_changed or changed;
			changed, cached_config.tracked_monster_types.large_monsters =
				imgui.checkbox(language.current_language.customization_menu.large_monsters,
					cached_config.tracked_monster_types.large_monsters);
			config_changed = config_changed or changed;
			tracked_monster_types_changed = tracked_monster_types_changed or changed;
		...
		if imgui.tree_node(language.current_language.customization_menu.tracked_damage_types) then
			...
			changed, cached_config.tracked_damage_types.player_damage =
				imgui.checkbox(language.current_language.customization_menu.player_damage,
					cached_config.tracked_damage_types.player_damage);
			config_changed = config_changed or changed;
			...
			config_changed = config_changed or changed;
			tracked_damage_types_changed = tracked_damage_types_changed or changed;
			changed, cached_config.tracked_damage_types.kunai_damage =
				imgui.checkbox(language.current_language.customization_menu.kunai_damage,
					cached_config.tracked_damage_types.kunai_damage);
			config_changed = config_changed or changed;
			tracked_damage_types_changed = tracked_damage_types_changed or changed;
			changed, cached_config.tracked_damage_types.installation_damage =
				imgui.checkbox(language.current_language.customization_menu.installation_damage,
					cached_config.tracked_damage_types.installation_damage);
			config_changed = config_changed or changed;
			tracked_damage_types_changed = tracked_damage_types_changed or changed;
			changed, cached_config.tracked_damage_types.otomo_damage =
				imgui.checkbox(language.current_language.customization_menu.otomo_damage,
					cached_config.tracked_damage_types.otomo_damage);
			config_changed = config_changed or changed;
			tracked_damage_types_changed = tracked_damage_types_changed or changed;
			changed, cached_config.tracked_damage_types.wyvern_riding_damage =
				imgui.checkbox(language.current_language.customization_menu.wyvern_riding_damage,
					cached_config.tracked_damage_types.wyvern_riding_damage);
			config_changed = config_changed or changed;
			tracked_damage_types_changed = tracked_damage_types_changed or changed;
			changed, cached_config.tracked_damage_types.poison_damage =
				imgui.checkbox(language.current_language.customization_menu.poison_damage,
					cached_config.tracked_damage_types.poison_damage);
			config_changed = config_changed or changed;
			tracked_damage_types_changed = tracked_damage_types_changed or changed;
			changed, cached_config.tracked_damage_types.blast_damage =
				imgui.checkbox(language.current_language.customization_menu.blast_damage,
					cached_config.tracked_damage_types.blast_damage);
			config_changed = config_changed or changed;
			tracked_damage_types_changed = tracked_damage_types_changed or changed;
			changed, cached_config.tracked_damage_types.endemic_life_damage =
				imgui.checkbox(language.current_language.customization_menu.endemic_life_damage,
					cached_config.tracked_damage_types.endemic_life_damage);
			config_changed = config_changed or changed;
			tracked_damage_types_changed = tracked_damage_types_changed or changed;
			changed, cached_config.tracked_damage_types.other_damage =
				imgui.checkbox(language.current_language.customization_menu.other_damage,
					cached_config.tracked_damage_types.other_damage);
			config_changed = config_changed or changed;
			tracked_damage_types_changed = tracked_damage_types_changed or changed;
		...
		if imgui.tree_node(language.current_language.customization_menu.sorting) then
			changed, index = imgui.combo(language.current_language.customization_menu.type, table_helpers.find_index(
				customization_menu.damage_meter_UI_sorting_types, cached_config.sorting.type),
				customization_menu.displayed_damage_meter_UI_sorting_types);
			config_changed = config_changed or changed;
			if changed then
		...
		if imgui.tree_node(language.current_language.customization_menu.player_name_label) then
			...
			if imgui.tree_node(language.current_language.customization_menu.include) then
				if imgui.tree_node(language.current_language.customization_menu.me) then
					changed, cached_config.player_name_label.include.myself.master_rank =
						imgui.checkbox(language.current_language.customization_menu.master_rank,
							cached_config.player_name_label.include.myself.master_rank);
					config_changed = config_changed or changed;
					changed, cached_config.player_name_label.include.myself.hunter_rank =
						imgui.checkbox(language.current_language.customization_menu.hunter_rank,
							cached_config.player_name_label.include.myself.hunter_rank);
					config_changed = config_changed or changed;
					changed, cached_config.player_name_label.include.myself.cart_count =
						imgui.checkbox(language.current_language.customization_menu.cart_count,
							cached_config.player_name_label.include.myself.cart_count);
					config_changed = config_changed or changed;
					changed, cached_config.player_name_label.include.myself.word_player =
						imgui.checkbox(language.current_language.customization_menu.word_player,
							cached_config.player_name_label.include.myself.word_player);
					config_changed = config_changed or changed;
					changed, cached_config.player_name_label.include.myself.player_id =
						imgui.checkbox(language.current_language.customization_menu.player_id,
							cached_config.player_name_label.include.myself.player_id);
					config_changed = config_changed or changed;
					changed, cached_config.player_name_label.include.myself.player_name =
						imgui.checkbox(language.current_language.customization_menu.player_name,
							cached_config.player_name_label.include.myself.player_name);
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
				if imgui.tree_node(language.current_language.customization_menu.other_players) then
					changed, cached_config.player_name_label.include.others.master_rank =
						imgui.checkbox(language.current_language.customization_menu.master_rank,
							cached_config.player_name_label.include.others.master_rank);
					config_changed = config_changed or changed;
					changed, cached_config.player_name_label.include.others.hunter_rank =
						imgui.checkbox(language.current_language.customization_menu.hunter_rank,
							cached_config.player_name_label.include.others.hunter_rank);
					config_changed = config_changed or changed;
					changed, cached_config.player_name_label.include.others.cart_count =
						imgui.checkbox(language.current_language.customization_menu.cart_count,
							cached_config.player_name_label.include.others.cart_count);
					config_changed = config_changed or changed;
					changed, cached_config.player_name_label.include.others.word_player =
						imgui.checkbox(language.current_language.customization_menu.word_player,
							cached_config.player_name_label.include.others.word_player);
					config_changed = config_changed or changed;
					changed, cached_config.player_name_label.include.others.player_id =
						imgui.checkbox(language.current_language.customization_menu.player_id,
							cached_config.player_name_label.include.others.player_id);
					config_changed = config_changed or changed;
					changed, cached_config.player_name_label.include.others.player_name =
						imgui.checkbox(language.current_language.customization_menu.player_name,
							cached_config.player_name_label.include.others.player_name);
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
				imgui.tree_pop();
			...
			if imgui.tree_node(language.current_language.customization_menu.shadow) then
				changed, cached_config.player_name_label.shadow.visibility =
					imgui.checkbox(language.current_language.customization_menu.visible,
						cached_config.player_name_label.shadow.visibility);
				config_changed = config_changed or changed;
				if imgui.tree_node(language.current_language.customization_menu.offset) then
					changed, cached_config.player_name_label.shadow.offset.x =
						imgui.drag_float(language.current_language.customization_menu.x, cached_config.player_name_label.shadow.offset.x,
							0.1, -screen.width, screen.width, "%.1f");
					config_changed = config_changed or changed;
					changed, cached_config.player_name_label.shadow.offset.y =
						imgui.drag_float(language.current_language.customization_menu.y, cached_config.player_name_label.shadow.offset.y,
							0.1, -screen.height, screen.height, "%.1f");
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
		...
		if imgui.tree_node(language.current_language.customization_menu.hunter_rank_label) then
			changed, cached_config.master_hunter_rank_label.visibility =
				imgui.checkbox(language.current_language.customization_menu.visible,
					cached_config.master_hunter_rank_label.visibility);
			config_changed = config_changed or changed;
			if imgui.tree_node(language.current_language.customization_menu.include) then
				if imgui.tree_node(language.current_language.customization_menu.me) then
			...
			if imgui.tree_node(language.current_language.customization_menu.offset) then
				changed, cached_config.master_hunter_rank_label.offset.x =
					imgui.drag_float(language.current_language.customization_menu.x, cached_config.master_hunter_rank_label.offset.x,
						0.1, -screen.width, screen.width, "%.1f");
				config_changed = config_changed or changed;
				changed, cached_config.master_hunter_rank_label.offset.y =
					imgui.drag_float(language.current_language.customization_menu.y, cached_config.master_hunter_rank_label.offset.y,
						0.1, -screen.height, screen.height, "%.1f");
				config_changed = config_changed or changed;
				imgui.tree_pop();
			end
			...
			if imgui.tree_node(language.current_language.customization_menu.shadow) then
				changed, cached_config.master_hunter_rank_label.shadow.visibility =
					imgui.checkbox(language.current_language.customization_menu.visible,
						cached_config.master_hunter_rank_label.shadow.visibility);
				config_changed = config_changed or changed;
				if imgui.tree_node(language.current_language.customization_menu.offset) then
					changed, cached_config.master_hunter_rank_label.shadow.offset.x =
						imgui.drag_float(language.current_language.customization_menu.x,
							cached_config.master_hunter_rank_label.shadow.offset.x, 0.1, -screen.width, screen.width, "%.1f");
					config_changed = config_changed or changed;
					changed, cached_config.master_hunter_rank_label.shadow.offset.y =
						imgui.drag_float(language.current_language.customization_menu.y,
							cached_config.master_hunter_rank_label.shadow.offset.y, 0.1, -screen.height, screen.height, "%.1f");
					config_changed = config_changed or changed;
					imgui.tree_pop();
				end
				if imgui.tree_node(language.current_language.customization_menu.color) then
