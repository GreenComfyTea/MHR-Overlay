...
function monster_health()
  ...
  if monster_UI.visibility.health_bar then
    ...
    local health_bar_delayed_health_width = monster_UI.health_bar.width * (monster_bar.current_percentage - monster.health_percentage);
    local health_bar_missing_health_width = monster_UI.health_bar.width - health_bar_remaining_health_width - health_bar_delayed_health_width;
    ...
    draw.filled_rect(screen_position.x + monster_UI.offsets.health_bar.x + health_bar_remaining_health_width, screen_position.y + monster_UI.offsets.health_bar.y, health_bar_delayed_health_width, monster_UI.health_bar.height, monster_UI.colors.health_bar.delayed_health);
    --missing health
    draw.filled_rect(screen_position.x + monster_UI.offsets.health_bar.x + health_bar_remaining_health_width + health_bar_delayed_health_width, screen_position.y + monster_UI.offsets.health_bar.y, health_bar_missing_health_width, monster_UI.health_bar.height, monster_UI.colors.health_bar.missing_health);
    ...
    if monster_bar.target_health < monster_bar.current_health then
      monster_bar.current_health = math.max(monster_bar.current_health - monster_UI.delay_health_change, monster_bar.target_health)
    end
    end
  end
  ...
  if (delayed_damage > 0) then
    ...
    draw.text(delayed_damage_text, 5 + screen_position.x + monster_UI.offsets.health_percentage.x + monster_UI.shadow_offsets.health_percentage.x, screen_position.y + monster_UI.offsets.monster_name.y + monster_UI.shadow_offsets.health_percentage.y, monster_UI.colors.health_percentage.shadow);
    draw.text(delayed_damage_text, 5 + screen_position.x + monster_UI.offsets.health_percentage.x, screen_position.y + monster_UI.offsets.monster_name.y, monster_UI.colors.health_percentage.text);
  end
